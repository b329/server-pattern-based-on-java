...
public class AuthorizeCommand implements Command
{
    ...
    public AuthorizeCommand withConsumerId(Long consumerId) {
        this.consumerId = consumerId;
        return this;
    }
    ...
    public AuthorizeCommand withOrderId(Long orderId) {
        this.orderId = orderId;
        return this;
    }
    ...
    public AuthorizeCommand withOrderTotal(String orderTotal) {
        this.orderTotal = orderTotal;
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(AuthorizeCommand.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof AuthorizeCommand) == false) {
            return false;
        }
        AuthorizeCommand rhs = ((AuthorizeCommand) other);
